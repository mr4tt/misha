 ...
 * @returns
 */
export function check_if_user_has_active_session(user_id: import('./types').StudentCardId): Promise<boolean>;
/**
 *
 * @param {import('./types').HumanReadablePcId} pc_id
 * @returns
 */
export function check_if_pc_has_active_session(pc_id: import('./types').HumanReadablePcId): Promise<boolean>;
